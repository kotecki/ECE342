...
.MODEL RIT4007P7 PMOS (LEVEL=8
+VERSION=3.3 CAPMOD=2 MOBMOD=1
+TOX=5E-8 XJ=2.26E-7 NCH=1E15 NSUB=8E14 XT=8.66E-8
+VTH0=-1.65 U0=400 WINT=1.0E-6 LINT=1E-6
+NGATE=5E20 RSH=90 JS=3.51E-8 JSW=3.51E-8 CJ=5.28E-8 MJ=0.5 PB=0.94
